...
#define ENCODER_COUNTS_PER_REV  540   //540 Set to the number of encoder pulses per wheel revolution
#define MM_PER_REV              251.327   // Og 220 Set to the number of mm per wheel revolution (Hence : Diameter * Pi)
#define ENCODER_COUNTS_90_DEG   161 //161   168.9165 157.9 Set to the number of encoder pulses to make a 90 degree turn og 725 before big wheel: 600 2/10/24: 588.5 
#define SPEED_MIN               350    // Minimum speed (pulses/second) use at the end of individual moves
#define ENCODER_COUNTS_90_DEGclose   10
...
#define MAX_COMMANDS    100      // Maximum number of motion commands allowed
...
#define VEHICLE_BACKWARD        20
#define VEHICLE_TURN_RIGHT      40
#define VEHICLE_TURN_LEFT       50
#define VEHICLE_TURN_FUNKY      80
#define VEHICLE_45DEGREE_LEFT   85
#define VEHICLE_45DEGREE_RIGHT   90
...
void loadCommandQueue() {
  ...
  //    SETTING THE SPEEDS ABOVE THE MOTOR'S MAXIMUM SPEED WILL CAUSE STRANGE RESULTS
      cmdQueue.add(VEHICLE_SET_MOVE_SPEED,700);     //700 Speed used for forward movements  
      cmdQueue.add(VEHICLE_SET_TURN_SPEED,700);     //200 Speed used for left or right turns
      cmdQueue.add(VEHICLE_SET_ACCEL, 300);         //700 smaller is softer   larger is quicker and less accurate moves7
        // Example list of robot movements
        // cmdQueue.add(VEHICLE_FORWARD,(417));

      //cmdQueue.add(VEHICLE_TURN_FUNKY,20); 

      //cmdQueue.add(VEHICLE_TURN_FUNKY,20); 
      cmdQueue.add(VEHICLE_FORWARD,(417/2));
      ...
      cmdQueue.add(VEHICLE_TURN_RIGHT);
      cmdQueue.add(VEHICLE_FORWARD,(417));
      cmdQueue.add(VEHICLE_BACKWARD,(417));
      cmdQueue.add(VEHICLE_TURN_LEFT);
      cmdQueue.add(VEHICLE_FORWARD,(417));
      cmdQueue.add(VEHICLE_TURN_LEFT);
      cmdQueue.add(VEHICLE_FORWARD,(417));
      ...
      cmdQueue.add(VEHICLE_FORWARD,(417));
      cmdQueue.add(VEHICLE_TURN_RIGHT);
      cmdQueue.add(VEHICLE_FORWARD,(2*417));
      cmdQueue.add(VEHICLE_TURN_LEFT);
      cmdQueue.add(VEHICLE_FORWARD,(417*2));
      cmdQueue.add(VEHICLE_BACKWARD,(417));
      cmdQueue.add(VEHICLE_TURN_LEFT);
      ...
      cmdQueue.add(VEHICLE_BACKWARD,(417));
      cmdQueue.add(VEHICLE_TURN_LEFT);
      cmdQueue.add(VEHICLE_FORWARD,(417*2/3));
    ...
    /*
      ...
      cmdQueue.add(VEHICLE_BACKWARD,(417));
      //cmdQueue.add(VEHICLE_TURN_FUNKY,20); 
      cmdQueue.add(VEHICLE_FORWARD,(417*3));
      cmdQueue.add(VEHICLE_TURN_RIGHT);
      cmdQueue.add(VEHICLE_FORWARD,(417));
      cmdQueue.add(VEHICLE_TURN_RIGHT);
      cmdQueue.add(VEHICLE_FORWARD,(417));
...
/*
      cmdQueue.add(VEHICLE_45DEGREE_RIGHT);
      cmdQueue.add(VEHICLE_45DEGREE_RIGHT);
      cmdQueue.add(VEHICLE_45DEGREE_RIGHT);
      cmdQueue.add(VEHICLE_45DEGREE_RIGHT);
      cmdQueue.add(VEHICLE_45DEGREE_RIGHT);
...
/*
      cmdQueue.add( VEHICLE_45DEGREE_LEFT);
      cmdQueue.add( VEHICLE_45DEGREE_LEFT);
      cmdQueue.add( VEHICLE_45DEGREE_LEFT);
      cmdQueue.add( VEHICLE_45DEGREE_LEFT);
      cmdQueue.add( VEHICLE_45DEGREE_LEFT);
  ...
  */    
      ...
      //cmdQueue.add(VEHICLE_FORWARD,(1098));Full block 4 *1097
      //cmdQueue.add(VEHICLE_FORWARD,(549));Half Block
      //cmdQueue.add(VEHICLE_FORWARD,(415*4));
      //cmdQueue.add(VEHICLE_FORWARD,(415));
      //cmdQueue.add(VEHICLE_FORWARD,(415));
      //cmdQueue.add(VEHICLE_TURN_RIGHT);
      ...
      /*
      cmdQueue.add(VEHICLE_FORWARD,(415/2));
      
      //cmdQueue.add(VEHICLE_TURN_FUNKY,23); 
      cmdQueue.add(VEHICLE_FORWARD,(415 * 3));
      cmdQueue.add(VEHICLE_TURN_RIGHT); 
      cmdQueue.add(VEHICLE_FORWARD,(415*3 ));
      cmdQueue.add(VEHICLE_TURN_RIGHT); 
      cmdQueue.add(VEHICLE_FORWARD,(415*3 ));
      ...
      /*cmdQueue.add(VEHICLE_FORWARD,(540.5)); //1081
      cmdQueue.add(VEHICLE_TURN_LEFT);
      cmdQueue.add(VEHICLE_FORWARD,(1081));
      cmdQueue.add(VEHICLE_TURN_RIGHT);
      cmdQueue.add(VEHICLE_TURN_RIGHT);
      cmdQueue.add(VEHICLE_FORWARD,(1081*2));
      cmdQueue.add(VEHICLE_TURN_LEFT);
      cmdQueue.add(VEHICLE_FORWARD,(1081*3));
      cmdQueue.add(VEHICLE_TURN_LEFT);
      cmdQueue.add(VEHICLE_TURN_LEFT);
      cmdQueue.add(VEHICLE_FORWARD,(1081*2));
      cmdQueue.add(VEHICLE_TURN_RIGHT);
      ...
      */
      ...
      /*cmdQueue.add(VEHICLE_TURN_LEFT);
      cmdQueue.add(VEHICLE_FORWARD,1098);
      cmdQueue.add(VEHICLE_TURN_LEFT);
      cmdQueue.add(VEHICLE_FORWARD,1098);
      cmdQueue.add(VEHICLE_TURN_RIGHT);
      cmdQueue.add(VEHICLE_FORWARD,1098);
      ...
      /*cmdQueue.add(VEHICLE_FORWARD,(1098*3)+549);
      cmdQueue.add(VEHICLE_TURN_RIGHT);
      cmdQueue.add(VEHICLE_FORWARD,(1098*3));
      cmdQueue.add(VEHICLE_TURN_RIGHT);
      cmdQueue.add(VEHICLE_FORWARD,(1098*3));
      cmdQueue.add(VEHICLE_TURN_RIGHT);
      cmdQueue.add(VEHICLE_FORWARD,1098);
      ...
      // cmdQueue.add(VEHICLE_FORWARD,625); 

      /*
      cmdQueue.add(VEHICLE_FORWARD,1200);
      cmdQueue.add(VEHICLE_FORWARD,1200);
      cmdQueue.add(VEHICLE_FORWARD,1200);
      cmdQueue.add(VEHICLE_TURN_LEFT);
      cmdQueue.add(VEHICLE_FORWARD,1200);
      ...
      cmdQueue.add(VEHICLE_FORWARD,1200);
      cmdQueue.add(VEHICLE_TURN_LEFT);
      cmdQueue.add(VEHICLE_FORWARD,750);
...
void loop() {
  ...
  if (cmdQueue.firstScan() || repeatCmd) {
    newCmd = true;
  ...
  switch (cmdQueue.current()) {
    ...
    case VEHICLE_FORWARD :
      if (newCmd) {
        ...
        speed = speedFwd;
        mtrLeft.startMove(distance*  0.9995 ,speed);
      ...
      if (newCmd) {
        ...
        speed = speedTurn;
        mtrLeft.startMove(distance * 0.995,speed); //0.994005
        mtrRight.startMove(distance* 0.995,speed * -1);
        setMotorOutputs();
      }
    ...
    case VEHICLE_TURN_LEFT :
      if (newCmd) {
        distance = ENCODER_COUNTS_90_DEG;
        speed = speedTurn;
        mtrLeft.startMove(distance*1.0205,speed * -1);
        mtrRight.startMove(distance*1.0205,speed);
        setMotorOutputs();
      }
      ...
      break;
    case VEHICLE_TURN_FUNKY :
        //Serial.println(flagTimeRun);
        Serial.print("timerRunTime"); 
        Serial.println(timerRunTime);
        Serial.print("timerPBStartOff"); 
        Serial.println(timerPBStartOff);
        //Serial.println(cmdQueue.getParameter1());

        if (newCmd||repeatCmd) {

          if (speedTurnFunky < 0){
            distance = ENCODER_COUNTS_90_DEG * 1.0205;
          } 
          else{
            distance = ENCODER_COUNTS_90_DEG * 0.995; //0.965 w/ 10 deg
          }
         
          speedTurnFunky = -1 * speedTurnFunky; 
          mtrLeft.startMove(distance,speedTurnFunky * -1);
          mtrRight.startMove(distance,speedTurnFunky);
          setMotorOutputs();
          repeatCmd = false; 
        ...
        if (mtrLeft.isStopped() && mtrRight.isStopped()) {      
          setMotorOutputs();
          delay(1750);
          if (timerRunTime < cmdQueue.getParameter1() * 1000000){
            repeatCmd = true; 
          }
          else if ( speedTurnFunky != speedTurn) {
            repeatCmd = true; 
    ...
    case VEHICLE_45DEGREE_LEFT: 
      if (newCmd) {
        distance = ENCODER_COUNTS_90_DEG/2;
        speed = speedTurn;
        mtrLeft.startMove(distance * 1.0205,speed * -1);
        mtrRight.startMove(distance * 1.0205,speed);
        setMotorOutputs();
      ...
      break;
    case VEHICLE_45DEGREE_RIGHT: 
      if (newCmd) {
        distance = ENCODER_COUNTS_90_DEG/2;
        speed = speedTurn;
        mtrLeft.startMove(distance * 0.985,speed);
        mtrRight.startMove(distance * 0.985,speed*-1);
        setMotorOutputs();
      }
    ...
    case VEHICLE_SET_TURN_SPEED :
      ...
      speedTurnFunky = cmdQueue.getParameter1(); 
      cmdQueue.next();
      break;
